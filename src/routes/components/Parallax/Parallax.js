    ...
    <>
      ...
      <Scene className="five">
        <ExplainWrap style={{ paddingTop: 10 }} alignItems={"center"}>
          ...
          <ExplainText>
            3️⃣ <strong>정류장 라인</strong> : 선택하신 방면의 정류장들을
            확인하실 수 있습니다. 정류장을 클릭하면 정류장 정보가 나타납니다.
          </ExplainText>
          <ExplainText>
            4️⃣ <strong>정류장 정보</strong> : 클릭하신 정류장(3️⃣)에 대한
            정보입니다. 해당 정류장의 위치, 막차, 도착예정 정보를 확인해보세요.
          </ExplainText>
        </ExplainWrap>
      </Scene>
      <Scene className="six">
        ...
        <ExplainWrap style={{ paddingTop: 10 }} alignItems={"center"}>
          ...
          <ExplainText>
            ...
            라인을 지도에 표시할지 여부를 결정하실 수 있습니다.
          </ExplainText>
          <ExplainText>
            2️⃣ <strong>노선 라인</strong> : 노선 라인 켜기를 선택하여, 해당
