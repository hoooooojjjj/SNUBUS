...
const stationList_end = [
  ...
  { children: "신소재(신림2동차고지 방면)", color: "blue" },
  {
  ...
  { children: "공대입구(신림2동차고지 방면)", color: "blue" },
  { children: "농생대(신림2동차고지 방면)", color: "blue" },
  {
  ...
  return (
    <Container>
      <StationLineWrap>
        ...
        <TimelineStyle items={isStart ? stationList_start : stationList_end} />
      </StationLineWrap>
    </Container>
  );
};
